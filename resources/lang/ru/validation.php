...
return [
    ...
    'email_blocked'        => 'Запрещенный русский адрес электронной почты',
    ...
    'custom'               => [
        ...
        'email.unique' => 'Аккаунт с такой почтой уже сущетсвует',
        'birthdate.before' => 'Тебе ещё нет 18 лет, иди делай уроки!',
    ],
    'attributes'           => [
        'address'               => 'Адрес',
        'age'                   => 'Возраст',
        ...
        'avatar.file' => 'Аватар',
        'photos.file' => 'Изображение',
        //'phones' => ['number' => ['phone' => 'Телефон']],
        'editorJsString' => 'Описание',
