...
{{--    @can('post.create')--}}
    <a href="{{ route('admin.meditations.create') }}" class="btn btn-flat btn-success mb-1"><i class="fa fa-plus"></i></a>
{{--    @endcan--}}
@endsection
...
@section('content')
    ...
    @include('admin.parts.content-header', [
        'page_title' => "Медитації: {$posts->total()}",
        'btn_search' => true,
        'btn_filter' => true,
    ])
    ...
    <section class="content">
        ...
        @include('admin.posts.meditations.inc.filter')
...
{{--                                            @can('post.update')--}}
                                            <a href="{{ route('admin.meditations.edit', $post) }}" class="dropdown-item">Редагувати</a>
{{--                                            @endcan--}}
{{--                                            @can('post.seo')--}}
...
{{--                                            @can('post.delete')--}}
                                            <a href="{{ route('admin.meditations.destroy', $post) }}" class="dropdown-item js-click-submit" data-method="delete" data-confirm="Видалити?">Видалити</a>
{{--                                            @endcan--}}
                                        </div>
                                    </div>
                                </td>
                                <td>
{{--                                    @can('post.update')--}}
                                        <a class="hover-edit" href="{{ route('admin.meditations.edit', $post) }}">{{ $post->name }}</a>
{{--                                    @else--}}
{{--                                        {{ $post->name }}--}}
{{--                                    @endcan--}}
